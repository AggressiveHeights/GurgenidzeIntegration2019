...
public class AllTheArbitraryThings {
   ...
   * one character only. Chars are also the building blocks of Strings, an object class heavily used
   * in java, composed of an array of Chars. Here's an example of the four main variables (boolean,
   * int double, String) in action:
   */
  ...
  public static void runArbitraryPSIOne() {
    ...
    // double
    System.out
        .println("\nNow, I know what you're thinking. How about doubles?" + " Enter one here: ");
    ...
    System.out.println("\nHere's a little trick...\nEnter a boolean value and I'll "
        + "tell you if you're right. Right about what? Well... that doesn't " + "really matter: ");
    ...
    System.out
        .println("\nPlease enter another String token. " + "I'll demonstrate an esape sequence: ");
    ...
    System.out.println("\nYet another one of my many abilities is casting. "
        + "I'll convert your String into a double. " + "Enter a decimal: ");
    ...
    System.out.println("\nYou entered the value " + doubleVarA + ". To prove that I"
        + "actually casted, here's your value squared: " + (doubleVarA * doubleVarA));
  ...
  public static void runArbitraryPSITwo() { // arbitrary code to meet requirements of PSI 2
    ...
    while (exampleA.equals(exampleB) != true) { // while loop example. equals tests the equality of
                                                // two Strings
      if (exampleA.compareTo(exampleB) == (randomSelectorA.nextInt(3) - 1)) { // compareTo
                                                                              // determines which
                                                                              // String is
                                                                              // lexiographically
                                                                              // larger
    ...
    do { // example of a do while loop
      System.out.println(
          "The count is at " + count + ". The loop" + " terminates when it falls to 20 or below.");
      count--;
    ...
    /*
     * Just like the order of operations in mathematics, Java has its own order of operations for
     * built-in expressions. More info, including a detailed order of all Java operations, can be
     * found at https://introcs.cs.princeton.edu/java/11precedence/
     */
  ...
  public static void runArbitraryPSIThree() { // meets all the objectives of PSI 3
    ...
    /*
     * Inheritance is a mechanism by which one object acquires all the properties and behaviors of
     * the parent object. The advantage is that, when declaring many objects of a similar design,
     * there is no need to create separate methods for every necessary function through overriding
     * and polymorphism.
     */
